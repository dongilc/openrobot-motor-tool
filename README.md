...
- **Windows**: `OpenRobot_Motor_Tool_v3.9.4.exe`
...
1. Download `OpenRobot_Motor_Tool_v3.9.4.exe` from [Releases](https://github.com/dongilc/openrobot-motor-tool/releases/latest)
